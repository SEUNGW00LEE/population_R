...
total_1925 = tapply(df_1234$`1925년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE) #1925년 총인구를 행정구역별로 sum합니다. na.rm=TRUE를 


total_1925 = tapply(df_1234$`1925년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1940 = tapply(df_1234$`1940년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1944 = tapply(df_1234$`1944년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1955 = tapply(df_1234$`1955년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1960 = tapply(df_1234$`1925년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1925 = tapply(df_1234$`1925년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1925 = tapply(df_1234$`1925년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1925 = tapply(df_1234$`1925년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
...
total_1944 = tapply(df_1234$`1944년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1955 = tapply(df_1234$`1955년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1960 = tapply(df_1234$`1960년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1966 = tapply(df_1234$`1966년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1970 = tapply(df_1234$`1970년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1975 = tapply(df_1234$`1975년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1980 = tapply(df_1234$`1980년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1985 = tapply(df_1234$`1985년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1990 = tapply(df_1234$`1990년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_1995 = tapply(df_1234$`1995년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2000 = tapply(df_1234$`2000년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2005 = tapply(df_1234$`2005년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2010 = tapply(df_1234$`2010년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2015 = tapply(df_1234$`2015년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2016 = tapply(df_1234$`2016년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2017 = tapply(df_1234$`2017년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2018 = tapply(df_1234$`2018년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2019 = tapply(df_1234$`2019년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2020 = tapply(df_1234$`2020년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
total_2021 = tapply(df_1234$`2021년 총인구(명)`, df_1234$행정구역별, sum, na.rm=TRUE)
