...
names(df_1234) <- c('행정구역별', "연령별", "1925년 총인구(명)", "1925년 남자인구(명)", "1925년 여자인구(명)", "1925년 성비", "1925년 총인구(명)", "1940년 남자인구(명)", "1940년 여자인구(명)", "1940년 성비", "1944년 총인구(명)", "1944년 남자인구(명)", "1944년 여자인구(명)", "1944년 성비", "1955년 총인구(명)", "1955년 남자인구(명)", "1955년 여자인구(명)", "1955년 성비", "1960년 총인구(명)", "1960년 남자인구(명)", "1960년 여자인구(명)", "1960년 성비", "1966년 총인구(명)", "1966년 남자인구(명)", "1966년 여자인구(명)", "1966년 성비", "1970년 총인구(명)", "1970년 남자인구(명)", "1970년 여자인구(명)", "1970년 성비", "1975년 총인구(명)", "1975년 남자인구(명)", "1975년 여자인구(명)", "1975년 성비", "1980년 총인구(명)", "1980년 남자인구(명)", "1980년 여자인구(명)", "1980년 성비", "1985년 총인구(명)", "1985년 남자인구(명)", "1985년 여자인구(명)", "1985년 성비", "1990년 총인구(명)", "1990년 남자인구(명)", "1990년 여자인구(명)", "1990년 성비", "1995년 총인구(명)", "1995년 남자인구(명)", "1995년 여자인구(명)", "1995년 성비", "2000년 총인구(명)", "2000년 남자인구(명)", "2000년 여자인구(명)", "2000년 성비", "2005년 총인구(명)", "2005년 남자인구(명)", "20005년 여자인구(명)", "2005년 성비", "2010년 총인구(명)", "2010년 남자인구(명)", "2010년 여자인구(명)", "2010년 성비", "2015년 총인구(명)", "2015년 남자인구(명)", "2015년 여자인구(명)", "2015년 성비",  "2016년 총인구(명)", "2016년 남자인구(명)", "2016년 여자인구(명)", "2016년 성비",  "2017년 총인구(명)", "2017년 남자인구(명)", "2017년 여자인구(명)", "2017년 성비",  "2018년 총인구(명)", "2018년 남자인구(명)", "2018년 여자인구(명)", "2018년 성비",  "2019년 총인구(명)", "2019년 남자인구(명)", "2019년 여자인구(명)", "2019년 성비",  "2020년 총인구(명)", "2020년 남자인구(명)", "2020년 여자인구(명)", "2020년 성비",  "2021년 총인구(명)", "2021년 남자인구(명)", "2021년 여자인구(명)", "2021년 성비") #column 값 변경
